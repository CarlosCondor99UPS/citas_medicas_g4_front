...
export class CitaComponent {
  ...
  async obtenerPersonasMedicos() {
    await this.personaServicio.obtenerPersonasMedicos().subscribe(
      (res: any[]) => {
  ...
  async obtenerPersonasPacientes() {
    await this.personaServicio.obtenerPersonasPacientes().subscribe(
      (res: any[]) => {

        this.personasPacientes=res;
